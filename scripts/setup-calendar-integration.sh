#!/bin/bash
#
# Calendar Integration Setup for Daily Tasks
# Creates calendar events with links to action dashboard
# Run once to generate calendar setup instructions
#
...
WORKSPACE_PATH="/Users/rubenruiz/.openclaw/workspace"
ACTION_DASHBOARD="file://${WORKSPACE_PATH}/action-dashboard.html"

cat > calendar-integration-guide.md << 'EOF'
...
echo "✅ Created: calendar-integration-guide.md"
echo ""
echo "📋 NEXT STEPS:"
echo "1. Open calendar-integration-guide.md"
echo "2. Copy the 4 calendar event templates"
echo "3. Paste into Google Calendar"
echo "4. Set daily recurrence"
echo ""
echo "🔗 QUICK TEST:"
echo "   Open: ${ACTION_DASHBOARD}"
echo ""
echo "⚡ Your workflow is now streamlined!"
