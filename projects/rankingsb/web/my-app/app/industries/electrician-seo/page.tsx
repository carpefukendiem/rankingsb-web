...
export const metadata: Metadata = industrySeoMetadata({
    canonicalPath: "/industries/electrician-seo",
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative py-20 lg:py-28 overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        <img
          src="https://images.unsplash.com/photo-1621905251918-48416bd8575a?w=1600&auto=format&fit=crop&q=70"
          alt="electrician professionals"
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <Card className="border-0 shadow-2xl">
                <CardContent className="p-8">
                  ...
                  <LeadForm source="electrician-seo" showWebsite={false} buttonText="Get My Free Audit" />
                </CardContent>
              </Card>
            </div>
          </div>
